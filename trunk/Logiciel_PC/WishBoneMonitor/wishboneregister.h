...
public:
    ...
    double          Value() const;
    unsigned long   ValueHex() const {return m_Value;}
    ...
    double          ScaleCoefficient() const {return m_ScaleCoefficient;}
    ...
    void            SetValueHex(unsigned long Value){m_Value = Value;}
    ...
    void            SetScaleCoefficient(double ScaleCoefficient){m_ScaleCoefficient = ScaleCoefficient; emit UpdateWidget();}
